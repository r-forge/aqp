...
d$g1 <- rep(1:20, each=5) # 5 / group
d$g2 <- rep(1:10, each=10) # 10 / group
d$g3 <- rep(1:5, each=20) # 20 / group
...
tt <- data.frame(profiles.per.group=factor(c(5, 10, 20, 100)), time=c(s1, s2, s3, s))
