...
Once further changes to genhz has been made, save a "horizon_agg.txt"" file which captures those changes for uploading to NASIS. (details on running calculation here). Comp summary report is run from NASIS data it will reflect all the custom changes to the genhz/comp layer field.
