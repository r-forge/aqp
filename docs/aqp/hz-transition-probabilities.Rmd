...
```{r transition-probabilities, fig.width=10, fig.height=6, htmlcap='Graph constructed from transition probabilities.'}
# sample data
data(sp4)
...
# https://cran.rstudio.com/web/packages/markovchain/vignettes/an_introduction_to_markovchain_package.pdf
...
# convert MC -> igraph for tinkering: not quite ready for use.
# g <- as(mc, 'igraph')
...
## try with KSSL data
s <- fetchKSSL('cecil')
tp <- hzTransitionProbabilities(s, 'hzn_desgn')
