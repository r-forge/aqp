...
# note that in this case we define an in-line function, 
# operating on a temporary SoilProfileCollection object "i" each time
...
xyplot(top ~ p.q50 | variable, data=agg, ylab='Depth',
			 ...
			 lower=agg$p.q25, upper=agg$p.q75, ylim=c(50,-5),
