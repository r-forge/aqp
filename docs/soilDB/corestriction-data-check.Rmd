...
# function for plotting SPC + associated restrictive feautures
plot.res.features <- function(i) {
  idx <- 1:length(i)
  plot(i, name='hzname')
  points(idx, i$resdept_r, col='red')
  points(idx, i$resdepb_r, col='red')
  segments(idx, i$resdept_r, idx, i$resdepb_r, lty=2, col='red')
}
