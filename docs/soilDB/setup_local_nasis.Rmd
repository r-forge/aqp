...
par(mar=c(0,0,0,0))
plot(fp[1:10, ], label='taxonname')
```

Good job, that wasn't so hard. If you are still interested, try [some examples from this tutorial](https://r-forge.r-project.org/scm/viewvc.php/*checkout*/docs/aqp/aqp-intro.html?root=aqp).
