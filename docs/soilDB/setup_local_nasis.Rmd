...
Access via control panels, or click: Start->Run, then paste in `odbccp32.cpl` and hit enter. This will open a small panel of ODBC connections in Windows XP. For Windows 7 see [this page](http://msdn.microsoft.com/en-us/library/ms188691.aspx). With the "User DSN" tab selected, create a new data source by clicking on the "Add..." button. 
