...
# the coordinate reference system should have units of meters
...
# init coordinates from WGS84 DD values
...
# project CRS of boundary polygon
s <- spTransform(s, CRS(proj4string(b)))
