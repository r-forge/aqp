...
The **what** parameter determines which chunk of data will be returned:
  ...
  * **lab**: measured/modeled bulk density and carbon concentration at the sample-level
  * **vnir**: VNIR spectra
...
# extract lab data horizon-level carbon and bulk density
lab <- r.series$lab

# init SoilProfileCollection
depths(lab) <- rcapid ~ sample_top + sample_bottom
