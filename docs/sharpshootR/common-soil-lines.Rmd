...
x <- readOGR(dsn='l:/CA792/ca792_spatial/FG_CA792_OFFICIAL_4_6_2015.gdb', layer='ca792_a', stringsAsFactors=FALSE)
...
plotSoilRelationGraph(res$adjMat, spanning.tree='max', edge.scaling.factor=0.1, vertex.scaling.factor=1)
plotSoilRelationGraph(res$adjMat, spanning.tree=0.9, edge.scaling.factor=0.1)
```

```{r ex-2, fig.width=10, fig.height=10}
par(mar=c(0,0,0,0))
